...
struct LIGHT {
	...
	BOOL Dummy[3];
	DirectX::SimpleMath::Vector4 Direction;	//平行光源
...
struct SUBSET {
	...
	unsigned int VertexNum = 0;		//インデックス数
	unsigned int IndexBase = 0;		//インデックス数
	unsigned int VertexBase = 0;	//インデックス数
	unsigned int MaterialIdx = 0;	//インデックス数
};
